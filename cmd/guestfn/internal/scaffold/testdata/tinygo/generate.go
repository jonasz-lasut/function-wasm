...
//go:generate protoc --plugin=protoc-gen-go=.bin/protoc-gen-go --plugin=protoc-gen-go-vtproto=.bin/protoc-gen-go-vtproto -I proto --go_out=. --go_opt=module=github.com/example/my-fn --go_opt=Mrun_function.proto=github.com/example/my-fn/internal/fnv1;fnv1 --go-vtproto_out=. --go-vtproto_opt=module=github.com/example/my-fn --go-vtproto_opt=Mrun_function.proto=github.com/example/my-fn/internal/fnv1;fnv1 --go-vtproto_opt=features=marshal+unmarshal+size run_function.proto
