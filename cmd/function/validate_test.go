		...
		"Refusals": {
			...
			want: want{
				stdout: strings.Join([]string{
					...
					fixture("refusals.yaml") + ": Composition/refusals pipeline[5] instructions-without-fuel: refused: limits.instructions is refused: the runtime was started without --enable-fuel",
