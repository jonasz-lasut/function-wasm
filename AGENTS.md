...
- `docs/one-pager-governance-perf.md` - per-module egress rate limits and fairness (per-Input concurrency, fair queueing, run-memory pool, opt-in input metric label) - phases over the resource-governance one-pager (implemented, revision 0.1)
